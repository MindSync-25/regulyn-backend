-- Create deletion schema
CREATE SCHEMA IF NOT EXISTS deletion;
...
CREATE TABLE audit_events (
    ...
    service TEXT NOT NULL DEFAULT 'retention-deletion-service',
...
INSERT INTO service_meta (name, version) VALUES ('retention-deletion-service', '0.0.1-SNAPSHOT');
