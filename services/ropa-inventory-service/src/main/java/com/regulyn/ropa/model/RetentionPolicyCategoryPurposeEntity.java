...
@Entity
@Table(name = "retention_policies_category_purpose", schema = "ropa")
public class RetentionPolicyCategoryPurposeEntity {
    ...
    @Column(name = "purpose_version_id", nullable = false)
